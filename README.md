...
$$\dfrac{\partial O}{\partial c_j}\displaystyle{\sum_{n=1}^{N}}z_{n,j}(\textbf{x}_{n}-\textbf{c}_j)\nonumber,$$ onde

$$c_j = \dfrac{\displaystyle{\sum_{n=1}^{N}}z_{n,j}\textbf{x}_{n}}{\sum_{n=1}^{N}}z_{n,j}}.$$
